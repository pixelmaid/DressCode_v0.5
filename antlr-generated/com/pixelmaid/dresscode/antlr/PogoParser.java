// $ANTLR 3.5 /Users/jenniferjacobs/Documents/MIT/HighLow_Tech/thesis/code/workspace/DressCode_v0.5/src/com/pixelmaid/dresscode/antlr/Pogo.g 2014-08-02 14:39:04
...
public class PogoParser extends Parser {
	...
	public final PogoParser.forStatement_return forStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: block, expression, expression, Identifier, For
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final PogoParser.repeatStatement_return repeatStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: Identifier, expression, block, expression, expression, Repeat
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
