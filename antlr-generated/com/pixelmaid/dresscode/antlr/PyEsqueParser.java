// $ANTLR 3.5 /Users/jenniferjacobs/Documents/MIT/HighLow_Tech/thesis/code/workspace/DressCode_v0.5/src/com/pixelmaid/dresscode/antlr/PyEsque.g 2014-08-02 14:38:54
...
public class PyEsqueParser extends Parser {
		...
		try {
			...
			switch (alt33) {
				...
				case 11 :
					...
					// AST REWRITE
					// elements: expression, Hide, OParen, CParen
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final PyEsqueParser.repeatStatement_return repeatStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: expression, Identifier, expression, expression, Repeat, block
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final PyEsqueParser.radialStatement_return radialStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: expression, Identifier, block, expression, Identifier, Identifier, Radial
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final PyEsqueParser.spiralStatement_return spiralStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: Identifier, Identifier, Identifier, Spiral, block, expression, expression
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final PyEsqueParser.rowStatement_return rowStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: Row, block, Identifier, expression, Identifier, expression, Identifier
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final PyEsqueParser.arcStatement_return arcStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: Identifier, Identifier, Identifier, expression, Arc, block, expression, Identifier, expression
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final PyEsqueParser.followCurveStatement_return followCurveStatement() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: expression, Identifier, block, statement, Identifier, FollowCurve
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
