...
public class TemplateSetCornerNode extends DrawableNode implements DCNode {

    public TemplateSetCornerNode(List<DCNode> ps, int l, int c) {
       super(ps,l);
    ...
    public VarType evaluate() {
		...
		try{
			...
			if(params.size()==2){
					...
					double rad = params.get(1).evaluate().asDouble();
					e.setRad(rad);
			...
			System.err.println("incorrect parameters for Template Set Corner at line:"+line);
			return null;
