...
public class RowStatementNode extends DCNode {

	private String numId;
	private String groupId;
	private String radId;
	private DCNode gapExpr;
	...
	public RowStatementNode(String gId, String rId, String nId, DCNode r, DCNode n,  DCNode bl, Scope s, int l, int c) {
		groupId = gId;
		radId= rId;
		numId= nId;
		gapExpr=r;
	...
	public VarType evaluate() {
		...
		double gap= gapExpr.evaluate().asDouble();
