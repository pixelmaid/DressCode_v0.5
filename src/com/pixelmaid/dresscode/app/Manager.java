...
public final class Manager extends JFrame implements WindowListener,ActionListener {
	...
	public static void setupFileChooser(Manager frame){
		...
		//createImageIcon("images/Save16.gif"));
		pathButton.addActionListener(frame);

		targetButton = new JButton("target");//,
		//createImageIcon("images/Save16.gif"));
		targetButton.addActionListener(frame);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == openButton) {
			...
			int returnVal = fc.showDialog(Manager.this, "Export");
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				File file = fc.getSelectedFile();
				canvas.print(file);
			}
			...
			int returnVal = fc.showDialog(Manager.this, "Select");
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				File file = fc.getSelectedFile();
				try {
