...
public class InstructionManager implements CustomEventListener{
	...
	public InstructionManager(DrawableManager dm) {
		lexer = new PogoLexer();
		drawableManager = dm;
	  ...
	  public void parseText(String userCode){
	    ...
	    //	output.setText(""); //clear the output console
	    	...
	    	// create the parser
	    	parser = new PogoParser(tokens,drawableManager);
	    	...
	    	try {
	    		...
	    		PogoTreeWalker walker = new PogoTreeWalker(nodes, parser.functions,drawableManager);
	    		...
	    		eventSource.fireEvent(this, CustomEvent.PARSE_COMPLETE);

	    	} catch (Exception e) {
	    		e.printStackTrace();
	    		error = e.getStackTrace().toString();
	    		//registers a parse error event
	    		eventSource.fireEvent(this,CustomEvent.PARSE_ERROR);
